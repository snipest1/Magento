...
MYSQL_PIDFILE=/home/tim/magento-1.9.0.1-2/mysql/data/mysqld.pid

MYSQL_START="/home/tim/magento-1.9.0.1-2/mysql/bin/mysqld_safe --defaults-file=/home/tim/magento-1.9.0.1-2/mysql/my.cnf --port=3325 --socket=/home/tim/magento-1.9.0.1-2/mysql/tmp/mysql.sock  --datadir=/home/tim/magento-1.9.0.1-2/mysql/data --log-error=/home/tim/magento-1.9.0.1-2/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
...
start_mysql() {
    ...
    if [ $ERROR -eq 0 ]; then
	echo "$0 $ARG: mysql  started at port 3325"
	sleep 2
    else
