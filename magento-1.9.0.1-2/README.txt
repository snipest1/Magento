                    Bitnami Magento Stack 1.9.0.1-2
                  ==============================
...
bitnami-magento-1.9.0.1-2-linux-installer.run on Linux or
bitnami-magento-1.9.0.1-2-linux-x64-installer.run on Linux 64 bit or
bitnami-magento-1.9.0.1-2-windows-installer.exe on Windows or
bitnami-magento-1.9.0.1-2-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-magento-1.9.0.1-2-linux.run
...
Stack in /home/user/magento-1.9.0.1-2 on Linux or C:\Program Files\Bitnami Magento Stack
on Windows or /Applications/magento-1.9.0.1-2 on OS X and that you use port 8080 
...
/home/user/magento-1.9.0.1-2/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami Magento Stack\apache2\logs\error.log on Windows or
/Applications/magento-1.9.0.1-2/apache2/logs/error.log.
